        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @method('PUT')
                ...
                <div class="grid grid-cols-1">
                    ...
                    <input name="descripcion" value="{{ $producto->descripcion }}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" inlength="4" maxlength="800" required/>
                </div>
                <div class="grid grid-cols-1">
